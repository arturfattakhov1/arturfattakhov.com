...
export const contactPageCopy: Record<Language, {
  ...
  ru: {
    ...
    success: 'Сообщение отправлено. Я рассмотрю обращение и отвечу по email, если ответ требуется.',
  ...
  en: {
    ...
    success: 'Your message has been sent. I will review it and reply by email if a response is required.',
